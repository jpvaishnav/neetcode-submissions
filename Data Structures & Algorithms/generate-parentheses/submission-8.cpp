...
public:
    ...
    void generate(string &p, int i, int max_chars, vector<string> &ans, int opening_brackets, int closing_brackets)
    {
        ...
        //opening_brackets++; this was with address
        p[i] = '(';
    ...
    vector<string> generateParenthesis(int n) {
        ...
        optimized by passing all values with reference

        visual image of tree at - https://github.com/jpvaishnav/Profile/blob/main/images/generate_para.jpg
        */
        vector<string> ans;
        int max_chars = 2*n;
        ...
        generate(s, 0, max_chars, ans, opening_brackets, closing_brackets);
