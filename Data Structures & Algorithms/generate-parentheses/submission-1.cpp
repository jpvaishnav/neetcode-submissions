...
public:
    ...
    void generate(string p, int i, int max_chars, vector<string> &ans, int opening_brackets, int closing_brackets)
    {
        ...
        generate(p+'(', i+1, max_chars, ans, opening_brackets+1, closing_brackets);
        generate(p+')', i+1, max_chars, ans, opening_brackets, closing_brackets+1);
    }
