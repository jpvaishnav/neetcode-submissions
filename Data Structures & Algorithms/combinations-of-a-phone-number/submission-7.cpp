...
public:
    ...
    vector<string> letterCombinations(string digits) {
        ...
        - Passing string as ref(clean code) + putting digits in a const vector of fixed size gave optimal run time

        https://github.com/jpvaishnav/Profile/blob/main/images/phone_letters.jpg
        */
