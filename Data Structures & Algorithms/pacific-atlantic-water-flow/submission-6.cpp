...
public:
    ...
    vector<vector<int>> pacificAtlantic(vector<vector<int>>& heights) {
        ...
        */
        ...
        - from optimization point of view, atlatic and pacific matrix could be combibned to one
            by using vector<vector<int>> with 3 states we earlier had -1, 0, 1
            but this code block has better readability
        */
