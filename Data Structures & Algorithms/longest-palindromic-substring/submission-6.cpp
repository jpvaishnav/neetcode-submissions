...
💡 Which optimization path do you want to explore first? If you choose one, I can provide a conceptual breakdown of how it works without giving you any code!
        ...
        // space is O(1), but time is still O(n*n)
        // 43 ms time, need further time optimization

        O(n) optimization is possible through Manchar's algorithm

        visuals at https://github.com/jpvaishnav/Profile/blob/main/images/dp_lps.jpg
        ...
        */
        ...
        // return lps;
            ...
            for(int i=0; i<n; i++)
            {
                ...
                if(max_len == n)
                {
                    // early exit optimization by entire string is detected as longest palindrom, no further solution exits
                    break;
                }
            }
