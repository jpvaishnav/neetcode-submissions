...
public:
  ...
  nums[3]=2)   nums[3]=2)     nums[3]=2)        nums[3]=2)
        ...
        Cleaner solution: Similar to N Queen and Sudoko
            ...
            Yes, there is a cleaner and much more common backtracking solution that eliminates the boolean flag entirely.Instead of using a binary Include/Exclude decision tree, you use a Loop-Based State Exploration tree.
        */
