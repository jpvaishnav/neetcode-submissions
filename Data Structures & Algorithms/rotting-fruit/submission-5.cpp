...
public:
    ...
    int orangesRotting(vector<vector<int>>& grid) {
        ...
        Now time complexity is : O(m*n * m*n)
            - for every node, there could be m*n traversal worst case
        Optimization:
            - Will DFS help in optimizing space?
            - Early exit by checking if a 1 is surrounded by 0s?
        */
